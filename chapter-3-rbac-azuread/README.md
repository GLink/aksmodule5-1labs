...
echo "✅ Verified Azure AD integration"
```
...
echo "✅ Azure AD group created: $DEV_GROUP_NAME"
echo "   Group ID: $DEV_GROUP_ID"
```
...
echo "✅ Azure AD group created: $VIEWER_GROUP_NAME"
echo "   Group ID: $VIEWER_GROUP_ID"
```
...
echo "✅ Developer role created in dev-team namespace"
```
...
echo "✅ RoleBinding created for developers in dev-team namespace"
```
...
echo "✅ Viewer ClusterRole created"
```
...
echo "✅ ClusterRoleBinding created for viewers"
```
...
echo "✅ Test application deployed in dev-team namespace"
...
echo "✅ Test application deployed in prod-team namespace"
```
...
echo -e "\n=== Testing developer group permissions ==="
...
echo -e "\n=== Testing viewer group permissions ==="
...
echo "✅ Production admin role created"
```
...
echo "✅ CI/CD deployer service account and role created"
```
...
kubectl create token cicd-deployer -n dev-team --duration=1h > /tmp/cicd-token.txt

# Test creating a deployment using the service account
kubectl create deployment test-deploy --image=nginx:alpine -n dev-team \
  --dry-run=client -o yaml > /tmp/test-deployment.yaml

# Apply using service account token (for testing)
echo "Service account token created at /tmp/cicd-token.txt"
...
kubectl get clusterroles | grep -E "developer|viewer|prod"

# List all clusterrolebindings
kubectl get clusterrolebindings | grep -E "developer|viewer|prod"
...
echo "✅ Aggregated ClusterRole created"
```
...
echo "✅ RBAC demo resources cleaned up"
```
